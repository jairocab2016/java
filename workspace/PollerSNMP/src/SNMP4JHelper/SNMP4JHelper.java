...
public class SNMP4JHelper {
	...
	public static void main(String[] args) {
		try {
			...
			//////////////////////////////////////////
			int Value = 2;
			// objSNMP.snmpSet(strIPAddress,
			// WRITE_COMMUNITY,OID_UPS_OUTLET_GROUP1, Value);
			//////////////////////////////////////////////////////////
	...
	/*
	 * The following code valid only SNMP version1. This method is very useful
	 * to set a parameter on remote device.
	 */
	...
	/*
	 * The code is valid only SNMP version1. SnmpGet method return Response for
	 * given OID from the Device.
	 */
